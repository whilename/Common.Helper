...
namespace ThoughtWorks.QRCode.Geom
{
    public class Axis
    {
        ...
        public virtual Point Origin { set { this.origin = value; } }

        public virtual int ModulePitch { set { this.modulePitch = value; } }
        ...
        public virtual Point translate(Point offset) { return this.translate(offset.X, offset.Y); }
