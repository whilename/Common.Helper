...
namespace ThoughtWorks.QRCode.Geom
{
    public class Line
    {
        ...
        public virtual bool Horizontal { get { return this.y1 == this.y2; } }

        public virtual bool Vertical { get { return this.x1 == this.x2; } }

        public virtual Point Center { get { return new Point((this.x1 + this.x2) / 2, (this.y1 + this.y2) / 2); } }
        ...
        public Line() { this.x1 = this.y1 = this.x2 = this.y2 = 0; }
        ...
        public virtual Point getP1() { return new Point(this.x1, this.y1); }

        public virtual Point getP2() { return new Point(this.x2, this.y2); }
        ...
        public virtual void setP1(Point p1) { this.x1 = p1.X; this.y1 = p1.Y; }

        public virtual void setP1(int x1, int y1) { this.x1 = x1; this.y1 = y1; }

        public virtual void setP2(Point p2) { this.x2 = p2.X; this.y2 = p2.Y; }

        public virtual void setP2(int x2, int y2) { this.x2 = x2; this.y2 = y2; }
        ...
        public override string ToString() { return "(" + this.x1 + "," + this.y1 + ")-(" + this.x2 + "," + this.y2 + ")"; }
    }
}
