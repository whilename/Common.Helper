...
namespace ThoughtWorks.QRCode.Codec.Ecc
{
    ...
    {
        internal static string[] bitName = new string[15] { "c0", "c1", "c2", "c3", "c4", "c5", "c6", "c7", "c8", "c9", "d0", "d1", "d2", "d3", "d4" };
        internal int[][] gf16;
        internal bool[] recieveData;
        internal int numCorrectedError;

        public virtual int NumCorrectedError { get { return this.numCorrectedError; } }
