...
namespace ThoughtWorks.QRCode.Codec
{
    public class QRCodeDecoder
    {
        ...
        internal virtual sbyte[] getDecodedByteArray(int[] blocks, int version, int numErrorCorrectionCode)
        {
            ...
            sbyte[] dataByte;
            try { dataByte = codeDataBlockReader.DataByte; }
            catch (InvalidDataBlockException ex) { throw ex; }
            return dataByte;
        }
        ...
        internal virtual string getDecodedString(int[] blocks, int version, int numErrorCorrectionCode)
        {
            QRCodeDataBlockReader codeDataBlockReader = new QRCodeDataBlockReader(blocks, version, numErrorCorrectionCode);
            string dataString;
            try { dataString = codeDataBlockReader.DataString; }
            catch (IndexOutOfRangeException ex) { throw new InvalidDataBlockException(ex.Message); }
            return dataString;
        }
        ...
        internal class DecodeResult
        {
            ...
            public virtual sbyte[] DecodedBytes { get { return this.decodedBytes; } }

            public virtual int NumErrors { get { return this.numCorrections; } }

            public virtual bool CorrectionSucceeded { get { return this.correctionSucceeded; } }

            public QRCodeDecoder Enclosing_Instance { get { return this.enclosingInstance; } }
