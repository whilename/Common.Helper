...
namespace ThoughtWorks.QRCode.Codec.Reader
{
    public class QRCodeImageReader
    {
        ...
        private class ModulePitch
        {
            ...
            public QRCodeImageReader Enclosing_Instance { get { return this.enclosingInstance; } }

            public ModulePitch(QRCodeImageReader enclosingInstance) { this.InitBlock(enclosingInstance); }

            private void InitBlock(QRCodeImageReader enclosingInstance) { this.enclosingInstance = enclosingInstance; }
        }
    }
}
