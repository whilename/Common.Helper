...
namespace SmartPortal.Controllers
{
    ...
    {
        private SmartDB smartDB = new SmartDB();

        /// <summary>网站首页</summary>
        /// <returns></returns>
        ...
        /// <summary>产品展示</summary>
        /// <returns></returns>
        public ActionResult Products(int id = 1)
        {
            var data = from m in smartDB.Products
