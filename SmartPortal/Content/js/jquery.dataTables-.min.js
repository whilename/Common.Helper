...
(function ($) {
    ...
    _oExt.oPagination = {
        two_button: {
            fnInit: function (oSettings, nPaging, fnCallbackDraw) {
                ...
                if (!oSettings.bJUI) { nPrevious = document.createElement("div"); nNext = document.createElement("div") }
                    ...
                    nPrevious = document.createElement("a"); nNext = document.createElement("a"); nNextInner = document.createElement("span");
        ...
        full_numbers: {
            fnInit: function (oSettings, nPaging, fnCallbackDraw) {
                ...
                var oClasses = oSettings.oClasses; nFirst.className = oClasses.sPageButton + " disabled " + oClasses.sPageFirst;
                nPrevious.className = oClasses.sPageButton + " disabled " + oClasses.sPagePrevious;
                nNext.className = oClasses.sPageButton + " disabled " + oClasses.sPageNext;
                nLast.className = oClasses.sPageButton + " disabled " + oClasses.sPageLast;
            ...
            fnUpdate: function (oSettings, fnCallbackDraw) {
                ...
                var sList = ""; var iStartButton, iEndButton, i, iLen; var oClasses = oSettings.oClasses;
                if (iPages < iPageCount) { iStartButton = 1; iEndButton = iPages }
                else {
                    if (iCurrentPage <= iPageCountHalf) { iStartButton = 1; iEndButton = iPageCount }
                    else {
                        if (iCurrentPage >= (iPages - iPageCountHalf)) { iStartButton = iPages - iPageCount + 1; iEndButton = iPages }
                ...
                for (i = iStartButton; i <= iEndButton; i++) {
                    ...
                    else { sList += '<span class="'+ oClasses.sPageButton +' '+ oClasses.sPageButtonActive + '">' + i + "</span>" }
                }
                var an = oSettings.aanFeatures.p; var anButtons, anStatic, nPaginateList;
                ...
                for (i = 0, iLen = an.length; i < iLen; i++) {
                    ...
                    nPaginateList = an[i].childNodes[2]; nPaginateList.innerHTML = sList;
                    ...
                    if (iCurrentPage == 1) {
                        anStatic[0].className += " disabled";
                        anStatic[1].className += " disabled";
                    } /*else {
                        anStatic[0].className += " " + oClasses.sPageButton;
                        anStatic[1].className += " " + oClasses.sPageButton
                    }*/
                    if (iPages === 0 || iCurrentPage == iPages || oSettings._iDisplayLength == -1) {
                        anStatic[2].className += " disabled";
                        anStatic[3].className += " disabled";
                    } /*else {
    ...
    _oExt.oSort = {
        "string-asc": function (a, b) {
            ...
            var x = Date.parse(a);
            var y = Date.parse(b);
            if (isNaN(x)) { x = Date.parse("01/01/1970 00:00:00") }
            if (isNaN(y)) { y = Date.parse("01/01/1970 00:00:00") } return x - y
        }, "date-desc": function (a, b) {
            var x = Date.parse(a); var y = Date.parse(b);
            if (isNaN(x)) { x = Date.parse("01/01/1970 00:00:00") }
            ...
            var x = a == "-" ? 0 : a;
            var y = b == "-" ? 0 : b; return y - x
        }
    };
    _oExt.aTypes = [function (sData) {
        if (typeof sData == "number") { return "numeric" }
        else { if (typeof sData.charAt != "function") { return null } }
        var sValidFirstChars = "0123456789-"; var sValidChars = "0123456789.";
        var Char; var bDecimal = false; Char = sData.charAt(0);
    ...
    $.fn.dataTable = function (oInit) {
        function classSettings() {
            this.fnRecordsTotal = function () {
                if (this.oFeatures.bServerSide) { return this._iRecordsTotal }
                else { return this.aiDisplayMaster.length }
            };
            this.fnRecordsDisplay = function () {
                if (this.oFeatures.bServerSide) { return this._iRecordsDisplay }
                else { return this.aiDisplay.length }
            };
            this.fnDisplayEnd = function () {
                if (this.oFeatures.bServerSide) { return this._iDisplayStart + this.aiDisplay.length }
            ...
            this.aoOpenRows = []; this.sDom = "lfrtip"; this.sPaginationType = "full_numbers"; this.iCookieDuration = 60 * 60 * 2;
            ...
            this._iRecordsDisplay = 0; this.bJUI = false; this.oClasses = _oExt.oStdClasses; this.bFiltered = false; this.bSorted = false
        }
        ...
        this.fnFilter = function (sInput, iColumn, bEscapeRegex) {
            var oSettings = _fnSettingsFromNode(this[_oExt.iApiIndex]);
            if (typeof bEscapeRegex == "undefined") { bEscapeRegex = true }
        ...
        this.fnVersionCheck = function (sVersion) {
            var fnZPad = function (Zpad, count) {
                while (Zpad.length < count) { Zpad += "0" } return Zpad
            };
            var aThis = _oExt.sVersion.split("."); var aThat = sVersion.split("."); var sThis = "", sThat = "";
        ...
        this.fnAddData = function (mData, bRedraw) {
            if (mData.length === 0) { return [] } var aiReturn = [];
            var iTest; var oSettings = _fnSettingsFromNode(this[_oExt.iApiIndex]);
            if (typeof mData[0] == "object") {
                ...
                aiReturn.push(iTest)
            } oSettings.aiDisplay = oSettings.aiDisplayMaster.slice(); _fnBuildSearchArray(oSettings, 1);
        ...
        this.fnDeleteRow = function (mTarget, fnCallBack, bNullRow) {
            ...
            _fnDraw(oSettings); var aData = oSettings.aoData[iAODataIndex]._aData.slice();
        ...
        this.fnOpen = function (nTr, sHtml, sClass) {
            ...
            nNewCell.innerHTML = sHtml; var nTrs = $("tbody tr", oSettings.nTable);
        ...
        this.fnGetPosition = function (nNode) {
            var oSettings = _fnSettingsFromNode(this[_oExt.iApiIndex]);
            if (nNode.nodeName == "TR") { return _fnNodeToDataIndex(oSettings, nNode) } else {
        ...
        this.fnUpdate = function (mData, mRow, iColumn, bRedraw) {
            ...
            if (typeof mData != "object") {
                sDisplay = mData; oSettings.aoData[iRow]._aData[iColumn] = sDisplay;
        ...
        this.fnSetColumnVis = function (iCol, bShow) {
            ...
            if (bShow) {
                var iInsert = 0; for (i = 0; i < iCol; i++) {
                    if (oSettings.aoColumns[i].bVisible) { iInsert++ }
                }
                ...
                if (nTrFoot) { nTrFoot.removeChild(anTfootTh[iCol]) } anTds = _fnGetTdNodes(oSettings);
                for (i = 0, iLen = oSettings.aoData.length; i < iLen; i++) {
        ...
        this.fnPageChange = function (sAction, bRedraw) {
            var oSettings = _fnSettingsFromNode(this[_oExt.iApiIndex]);
            _fnPageChange(oSettings, sAction); _fnCalculateEnd(oSettings);
            if (typeof bRedraw == "undefined" || bRedraw) {
                _fnDraw(oSettings)
            }
        };
        ...
        function _fnInitalise(oSettings) {
            ...
            } _fnAddOptionsHtml(oSettings); _fnDrawHead(oSettings);
        ...
        function _fnAddColumn(oSettings, oOptions, nTh) {
            ...
            var iLength = oSettings.aoColumns.length - 1; var oCol = oSettings.aoColumns[iLength];
        ...
        function _fnAddData(oSettings, aData) {
            ...
            var iThisIndex = oSettings.aoData.length; oSettings.aoData.push({ nTr: document.createElement("tr"), _iId: oSettings.iNextId++, _aData: aData.slice(), _anHidden: [], _sRowStripe: "" });
            var nTd, sThisType;
            for (var i = 0; i < aData.length; i++) {
                ...
                if (oSettings.aoColumns[i]._bAutoType && oSettings.aoColumns[i].sType != "string") {
                    ...
                    if (oSettings.aoColumns[i].sType === null) { oSettings.aoColumns[i].sType = sThisType } else {
        ...
        function _fnGatherData(oSettings) {
            ...
            if (oSettings.sAjaxSource === null) {
                ...
                for (i = 0, iLen = nTrs.length; i < iLen; i++) {
                    if (nTrs[i].nodeName == "TR") {
                        ...
                        nTds = nTrs[i].childNodes; jInner = 0;
            ...
            } nTrs = _fnGetTrNodes(oSettings); nTds = [];
            for (i = 0, iLen = nTrs.length; i < iLen; i++) {
                for (j = 0, jLen = nTrs[i].childNodes.length; j < jLen; j++) {
                    nTd = nTrs[i].childNodes[j];
                    if (nTd.nodeName == "TD") { nTds.push(nTd) }
                }
            }
        ...
        function _fnDraw(oSettings) {
            ...
            } oSettings.bSorted = false; oSettings.bFiltered = false;
        ...
        function _fnAjaxUpdateDraw(oSettings, json) {
            if (typeof json.sEcho != "undefined") {
                if (json.sEcho * 1 < oSettings.iServerDraw) { return }
        ...
        function _fnAddOptionsHtml(oSettings) {
            ...
            if (oSettings.sTableId !== "") { nWrapper.setAttribute("id", oSettings.sTableId + "_wrapper") }
            ...
            var aDom = sDom.split(""); var nTmp, iPushFeature, cOption, nNewNode, cNext, sClass, j;
            for (var i = 0; i < aDom.length; i++) {
                iPushFeature = 0; cOption = aDom[i];
                if (cOption == "<") {
                    nNewNode = document.createElement("div"); cNext = aDom[i + 1];
                    if (cNext == "'" || cNext == '"') {
                        sClass = ""; j = 2;
                        ...
                        if (cOption == "l" && oSettings.oFeatures.bPaginate && oSettings.oFeatures.bLengthChange) {
                            ...
                            if (cOption == "f" && oSettings.oFeatures.bFilter) {
                                ...
                                if (cOption == "r" && oSettings.oFeatures.bProcessing) {
                                    ...
                                    if (cOption == "t") { nTmp = oSettings.nTable; iPushFeature = 1 }
                                    else {
        ...
        function _fnSort(oSettings, bApplyClasses) {
            var aaSort = []; var oSort = _oExt.oSort;
            var aoData = oSettings.aoData; var iDataSort; var iDataType; var i, j, jLen;
            if (!oSettings.oFeatures.bServerSide && (oSettings.aaSorting.length !== 0 || oSettings.aaSortingFixed !== null)) {
                if (oSettings.aaSortingFixed !== null) {
                    aaSort = oSettings.aaSortingFixed.concat(oSettings.aaSorting)
                } else { aaSort = oSettings.aaSorting.slice() } for (i = 0; i < aaSort.length; i++) {
                    ...
                    if (e.shiftKey) {
                        ...
                        for (var i = 0; i < oSettings.aaSorting.length; i++) {
                            if (oSettings.aaSorting[i][0] == iDataIndex) {
                                bFound = true;
                                iColumn = oSettings.aaSorting[i][0]; iNextSort = oSettings.aaSorting[i][2] + 1;
        ...
        function _fnSortingClasses(oSettings) {
            ...
            for (i = 0; i < oSettings.aoColumns.length; i++) {
                if (oSettings.aoColumns[i].bSortable) {
                    sClass = oSettings.aoColumns[i].sSortingClass; iFound = -1;
        ...
        function _fnFeatureHtmlPaginate(oSettings) {
            ...
            nPaginate.className = oSettings.oClasses.sPaging + oSettings.sPaginationType; _oExt.oPagination[oSettings.sPaginationType].fnInit(oSettings, nPaginate, function (oSettings) {
                _fnCalculateEnd(oSettings);
                _fnDraw(oSettings)
            });
        ...
        function _fnPageChange(oSettings, sAction) {
            ...
            if (sAction == "first") { oSettings._iDisplayStart = 0 } else {
                if (sAction == "previous") {
                    ...
                    if (sAction == "next") {
                        ...
                        } else { alert("DataTables warning: unknown paging action: " + sAction) }
                    }
                }
            } return iOldStart != oSettings._iDisplayStart
        }
        function _fnFeatureHtmlInfo(oSettings) {
            var nInfo = document.createElement("div"); nInfo.className = oSettings.oClasses.sInfo;
        ...
        function _fnUpdateInfo(oSettings) {
            ...
            if (n.length > 1) {
                ...
                for (var i = 1, iLen = n.length; i < iLen; i++) { n[i].innerHTML = sInfo }
            }
        }
        function _fnFeatureHtmlLength(oSettings) {
            ...
            $("select", nLength).change(function (e) {
                var iVal = $(this).val(); var n = oSettings.aanFeatures.l;
                for (var i = 0, iLen = n.length; i < iLen; i++) {
                    if (n[i] != this.parentNode) {
                        $("select", n[i]).val(iVal)
                    }
                } oSettings._iDisplayLength = parseInt(iVal, 10); _fnCalculateEnd(oSettings);
        ...
        function _fnVisbleColumns(oS) {
            ...
            for (var i = 0; i < oS.aoColumns.length; i++) {
                if (oS.aoColumns[i].bVisible === true) { iVis++ }
            } return iVis
        }
        ...
        function _fnCalculateColumnWidths(oSettings) {
            ...
            var i; var oHeaders = $("thead:eq(0)>th", oSettings.nTable);
            for (i = 0; i < iColums; i++) {
                if (oSettings.aoColumns[i].bVisible) {
                    iVisibleColumns++;
                    if (oSettings.aoColumns[i].sWidth !== null) {
                ...
                var oNodes = $("tr:eq(1)>td", nCalcTmp); var iIndex;
        ...
        function _fnArrayCmp(aArray1, aArray2) {
            ...
            for (var i = 0; i < aArray1.length; i++) {
                if (aArray1[i] != aArray2[i]) { return 2 }
            } return 0
        }
        ...
        function _fnSettingsFromNode(nTable) {
            for (var i = 0; i < _aoSettings.length; i++) {
                if (_aoSettings[i].nTable == nTable) { return _aoSettings[i] }
            } return null
        }
        function _fnGetDataMaster(oSettings) {
            ...
            for (var i = 0; i < iLen; i++) {
                if (oSettings.aoData[i] === null) { aData.push(null) }
        ...
        function _fnGetTrNodes(oSettings) {
            ...
            var iLen = oSettings.aoData.length;
            for (var i = 0; i < iLen; i++) {
                if (oSettings.aoData[i] === null) { aNodes.push(null) }
                else { aNodes.push(oSettings.aoData[i].nTr) }
            } return aNodes
        }
        function _fnGetTdNodes(oSettings) {
            var nTrs = _fnGetTrNodes(oSettings);
            var nTds = [], nTd; var anReturn = []; var iCorrector; var iRow, iRows, iColumn, iColumns;
        ...
        function _fnLoadState(oSettings, oInit) {
            ...
            var oData; var sData = _fnReadCookie("SpryMedia_DataTables_" + oSettings.sInstance);
            if (sData !== null && sData !== "") {
                try {
        ...
        function _fnGetUniqueThs(nThead) {
            ...
            var ROWSPAN = 2, COLSPAN = 3, TDELEM = 4; var i, j, k, iLen, jLen, iColumnShifted;
            ...
            for (i = 0, iLen = nTrs.length; i < iLen; i++) {
                fnAddRow(i); var iColumn = 0; var nTds = [];
                for (j = 0, jLen = nTrs[i].childNodes.length; j < jLen; j++) {
        ...
        function _fnMap(oRet, oSrc, sName, sMappedName) {
            if (typeof sMappedName == "undefined") { sMappedName = sName }
        ...
        this.oApi._fnReDraw = _fnReDraw; var _that = this;
        return this.each(function () {
            ...
            if (sId !== null) { oSettings.sTableId = sId; oSettings.sInstance = sId }
            else { oSettings.sInstance = _oExt._oExternConfig.iNextUnique++ }
            oSettings.nTable = this; oSettings.oApi = _that.oApi;
