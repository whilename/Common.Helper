...
nPrevious.className=oClasses.sPageButton+" disabled "+oClasses.sPagePrevious;nNext.className=oClasses.sPageButton+" disabled "+oClasses.sPageNext;
nLast.className=oClasses.sPageButton+" disabled "+oClasses.sPageLast;nPaging.appendChild(nFirst);
...
}else{sList+='<span class="'+oClasses.sPageButton+' '+oClasses.sPageButtonActive+'">'+i+"</span>"}}var an=oSettings.aanFeatures.p;
...
if(iCurrentPage==1){anStatic[0].className+=" disabled";anStatic[1].className+=" disabled"}
/*else{anStatic[0].className+=" "+oClasses.sPageButton;anStatic[1].className+=" "+oClasses.sPageButton}*/
if(iPages===0||iCurrentPage==iPages||oSettings._iDisplayLength==-1){anStatic[2].className+=" disabled";anStatic[3].className+=" disabled"}
/*else{anStatic[2].className+=" "+oClasses.sPageButton;anStatic[3].className+=" "+oClasses.sPageButton}*/}}}};
